...
<head>
	...
	<title>SignTransactionResponse | @blockone/universal-authenticator-library</title>
...
<nav class="tsd-navigation secondary">
	<ul>
		...
		<li class=" tsd-kind-interface">
			<a href="authenticatorresponse.html" class="tsd-kind-icon">Authenticator<wbr>Response</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="buttonstyle.html" class="tsd-kind-icon">Button<wbr>Style</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="chain.html" class="tsd-kind-icon">Chain</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="rpcendpoint.html" class="tsd-kind-icon">Rpc<wbr>Endpoint</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="signtransactionconfig.html" class="tsd-kind-icon">Sign<wbr>Transaction<wbr>Config</a>
		</li>
		<li class="current tsd-kind-interface">
			<a href="signtransactionresponse.html" class="tsd-kind-icon">Sign<wbr>Transaction<wbr>Response</a>
			<ul>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="signtransactionresponse.html#error" class="tsd-kind-icon">error</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="signtransactionresponse.html#status" class="tsd-kind-icon">status</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="signtransactionresponse.html#transaction" class="tsd-kind-icon">transaction</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="signtransactionresponse.html#transactionid" class="tsd-kind-icon">transaction<wbr>Id</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-interface">
					<a href="signtransactionresponse.html#wasbroadcast" class="tsd-kind-icon">was<wbr>Broadcast</a>
				</li>
			</ul>
		</li>
	</ul>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>The object returned from signTransaction</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">SignTransactionResponse</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="signtransactionresponse.html#error" class="tsd-kind-icon">error</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="signtransactionresponse.html#status" class="tsd-kind-icon">status</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="signtransactionresponse.html#transaction" class="tsd-kind-icon">transaction</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="signtransactionresponse.html#transactionid" class="tsd-kind-icon">transaction<wbr>Id</a></li>
							<li class="tsd-kind-property tsd-parent-kind-interface"><a href="signtransactionresponse.html#wasbroadcast" class="tsd-kind-icon">was<wbr>Broadcast</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">error<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">object</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/interfaces.ts#L63">interfaces.ts:63</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Set if there was an error</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<div class="tsd-signature tsd-kind-icon">status<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/interfaces.ts#L60">interfaces.ts:60</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The status of the transaction as returned by the RPC API (optional)</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/interfaces.ts#L75">interfaces.ts:75</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The raw transaction object</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="transactionid" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagOptional">Optional</span> transaction<wbr>Id</h3>
				<div class="tsd-signature tsd-kind-icon">transaction<wbr>Id<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/interfaces.ts#L57">interfaces.ts:57</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>The transcation id (optional)</p>
					</div>
				</div>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-interface">
				<a name="wasbroadcast" class="tsd-anchor"></a>
				<h3>was<wbr>Broadcast</h3>
				<div class="tsd-signature tsd-kind-icon">was<wbr>Broadcast<span class="tsd-signature-symbol">:</span> <span class="tsd-signature-type">boolean</span></div>
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/interfaces.ts#L54">interfaces.ts:54</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
						<p>Was the transaction broadcast</p>
					</div>
				</div>
			</section>
		</section>

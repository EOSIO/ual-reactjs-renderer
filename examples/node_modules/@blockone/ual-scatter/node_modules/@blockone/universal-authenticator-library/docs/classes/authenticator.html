...
<head>
	...
	<title>Authenticator | @blockone/universal-authenticator-library</title>
		...
		<div class="container">
			<div class="table-wrap">
				<div class="table-cell">
					<strong><a href="../index.html">@blockone/universal-authenticator-library</a></strong>
				</div>
...
<nav class="tsd-navigation secondary">
	<ul>
		<li class=" tsd-kind-enum">
			<a href="../enums/ualerrortype.html" class="tsd-kind-icon">UALError<wbr>Type</a>
		</li>
		<li class="current tsd-kind-class">
			<a href="authenticator.html" class="tsd-kind-icon">Authenticator</a>
			<ul>
				<li class=" tsd-kind-constructor tsd-parent-kind-class">
					<a href="authenticator.html#constructor" class="tsd-kind-icon">constructor</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class">
					<a href="authenticator.html#chains" class="tsd-kind-icon">chains</a>
				</li>
				<li class=" tsd-kind-property tsd-parent-kind-class">
					<a href="authenticator.html#options" class="tsd-kind-icon">options</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#geterror" class="tsd-kind-icon">get<wbr>Error</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#getonboardinglink" class="tsd-kind-icon">get<wbr>Onboarding<wbr>Link</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#getstyle" class="tsd-kind-icon">get<wbr>Style</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#init" class="tsd-kind-icon">init</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#iserrored" class="tsd-kind-icon">is<wbr>Errored</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#isloading" class="tsd-kind-icon">is<wbr>Loading</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#login" class="tsd-kind-icon">login</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#logout" class="tsd-kind-icon">logout</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#reset" class="tsd-kind-icon">reset</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#shouldautologin" class="tsd-kind-icon">should<wbr>Auto<wbr>Login</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#shouldrender" class="tsd-kind-icon">should<wbr>Render</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="authenticator.html#shouldrequestaccountname" class="tsd-kind-icon">should<wbr>Request<wbr>Account<wbr>Name</a>
				</li>
			</ul>
		</li>
		<li class=" tsd-kind-class">
			<a href="ual.html" class="tsd-kind-icon">UAL</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="ualerror.html" class="tsd-kind-icon">UALError</a>
		</li>
		<li class=" tsd-kind-class">
			<a href="user.html" class="tsd-kind-icon">User</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="../interfaces/authenticatorresponse.html" class="tsd-kind-icon">Authenticator<wbr>Response</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="../interfaces/buttonstyle.html" class="tsd-kind-icon">Button<wbr>Style</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="../interfaces/chain.html" class="tsd-kind-icon">Chain</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="../interfaces/rpcendpoint.html" class="tsd-kind-icon">Rpc<wbr>Endpoint</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="../interfaces/signtransactionconfig.html" class="tsd-kind-icon">Sign<wbr>Transaction<wbr>Config</a>
		</li>
		<li class=" tsd-kind-interface">
			<a href="../interfaces/signtransactionresponse.html" class="tsd-kind-icon">Sign<wbr>Transaction<wbr>Response</a>
		</li>
	</ul>
</nav>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Represents Button that is rendered for, and interfaces with, a specific Authenticator app.</p>
				</div>
			</div>
		</section>
		<section class="tsd-panel tsd-hierarchy">
			...
			<ul class="tsd-hierarchy">
				<li>
					<span class="target">Authenticator</span>
				</li>
			</ul>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-constructor tsd-parent-kind-class"><a href="authenticator.html#constructor" class="tsd-kind-icon">constructor</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Properties</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-property tsd-parent-kind-class"><a href="authenticator.html#chains" class="tsd-kind-icon">chains</a></li>
							<li class="tsd-kind-property tsd-parent-kind-class"><a href="authenticator.html#options" class="tsd-kind-icon">options</a></li>
						</ul>
					</section>
					<section class="tsd-index-section ">
						<h3>Methods</h3>
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#geterror" class="tsd-kind-icon">get<wbr>Error</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#getonboardinglink" class="tsd-kind-icon">get<wbr>Onboarding<wbr>Link</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#getstyle" class="tsd-kind-icon">get<wbr>Style</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#init" class="tsd-kind-icon">init</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#iserrored" class="tsd-kind-icon">is<wbr>Errored</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#isloading" class="tsd-kind-icon">is<wbr>Loading</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#login" class="tsd-kind-icon">login</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#logout" class="tsd-kind-icon">logout</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#reset" class="tsd-kind-icon">reset</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#shouldautologin" class="tsd-kind-icon">should<wbr>Auto<wbr>Login</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#shouldrender" class="tsd-kind-icon">should<wbr>Render</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="authenticator.html#shouldrequestaccountname" class="tsd-kind-icon">should<wbr>Request<wbr>Account<wbr>Name</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-constructor tsd-parent-kind-class">
				...
				<ul class="tsd-signatures tsd-kind-constructor tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">new <wbr>Authenticator<span class="tsd-signature-symbol">(</span>chains<span class="tsd-signature-symbol">: </span><a href="../interfaces/chain.html" class="tsd-signature-type">Chain</a><span class="tsd-signature-symbol">[]</span>, options<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="authenticator.html" class="tsd-signature-type">Authenticator</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L8">Authenticator.ts:8</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								<h5>chains: <a href="../interfaces/chain.html" class="tsd-signature-type">Chain</a><span class="tsd-signature-symbol">[]</span></h5>
								<div class="tsd-comment tsd-typography">
									<div class="lead">
										<p>This represents each of the chains that the dapp provides support for.</p>
									</div>
								</div>
							</li>
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<div class="lead">
										<p>Optional argument that is intended for Authenticator specific options.</p>
									</div>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="authenticator.html" class="tsd-signature-type">Authenticator</a></h4>
					</li>
				</ul>
			</section>
		</section>
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-property tsd-parent-kind-class">
				<a name="chains" class="tsd-anchor"></a>
				<h3>chains</h3>
				...
				<aside class="tsd-sources">
					<ul>
						<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L14">Authenticator.ts:14</a></li>
					</ul>
				</aside>
				<div class="tsd-comment tsd-typography">
					<div class="lead">
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> get<wbr>Error</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Error<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="ualerror.html" class="tsd-signature-type">UALError</a><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">null</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L40">Authenticator.ts:40</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns error (if available) if the authenticator has errored while initializing.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <a href="ualerror.html" class="tsd-signature-type">UALError</a>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="getonboardinglink" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> get<wbr>Onboarding<wbr>Link</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Onboarding<wbr>Link<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L35">Authenticator.ts:35</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns a URL where the user can download and install the underlying authenticator
								if it is not found by the UAL Authenticator.</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> get<wbr>Style</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Style<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/buttonstyle.html" class="tsd-signature-type">ButtonStyle</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L50">Authenticator.ts:50</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns the style of the Button that will be rendered.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <a href="../interfaces/buttonstyle.html" class="tsd-signature-type">ButtonStyle</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="init" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> init</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L19">Authenticator.ts:19</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Attempts to render the Authenticator and updates the authenticator&#39;s state, accordingly</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="iserrored" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> is<wbr>Errored</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">is<wbr>Errored<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L29">Authenticator.ts:29</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns true if the authenticator has errored while initializing.</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> is<wbr>Loading</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">is<wbr>Loading<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L45">Authenticator.ts:45</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns true if the authenticator is loading while initializing its internal state.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> login</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">login<span class="tsd-signature-symbol">(</span>accountName<span class="tsd-signature-symbol">?: </span><span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="user.html" class="tsd-signature-type">User</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L76">Authenticator.ts:76</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Login using the Authenticator App. This can return one or more users depending on multiple chain support.</p>
							</div>
						</div>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> accountName: <span class="tsd-signature-type">undefined</span><span class="tsd-signature-symbol"> | </span><span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>The account name of the user for Authenticators that do not store accounts (optional)</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="user.html" class="tsd-signature-type">User</a><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="logout" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> logout</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L81">Authenticator.ts:81</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Logs the user out of the dapp. This will be strongly dependent on each Authenticator app&#39;s patterns.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> reset</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
				...
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L24">Authenticator.ts:24</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Resets the authenticator to its initial, default state then calls init method</p>
							</div>
						</div>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="shouldautologin" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> should<wbr>Auto<wbr>Login</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">should<wbr>Auto<wbr>Login<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L63">Authenticator.ts:63</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns whether or not the dapp should attempt to auto login with the Authenticator app.
									Auto login will only occur when there is only one Authenticator that returns shouldRender() true and
								shouldAutoLogin() true.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="shouldrender" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> should<wbr>Render</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">should<wbr>Render<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L56">Authenticator.ts:56</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns whether or not the button should render based on the operating environment and other factors.
								ie. If your Authenticator App does not support mobile, it returns false when running in a mobile browser.</p>
							</div>
						</div>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">boolean</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="shouldrequestaccountname" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> should<wbr>Request<wbr>Account<wbr>Name</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">should<wbr>Request<wbr>Account<wbr>Name<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/Authenticator.ts#L69">Authenticator.ts:69</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
							<div class="lead">
								<p>Returns whether or not the button should show an account name input field.
								This is for Authenticators that do not have a concept of account names.</p>
							</div>
						</div>

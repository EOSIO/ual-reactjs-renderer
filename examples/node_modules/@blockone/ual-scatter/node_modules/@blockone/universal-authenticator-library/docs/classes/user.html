...
<head>
	...
	<title>User | @blockone/universal-authenticator-library</title>
		...
		<li class="current tsd-kind-class">
			...
			<ul>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-protected">
					<a href="user.html#buildrpcendpoint" class="tsd-kind-icon">build<wbr>Rpc<wbr>Endpoint</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="user.html#getaccountname" class="tsd-kind-icon">get<wbr>Account<wbr>Name</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="user.html#getchainid" class="tsd-kind-icon">get<wbr>Chain<wbr>Id</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="user.html#getkeys" class="tsd-kind-icon">get<wbr>Keys</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class tsd-is-protected">
					<a href="user.html#returneosjstransaction" class="tsd-kind-icon">return<wbr>Eosjs<wbr>Transaction</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="user.html#signarbitrary" class="tsd-kind-icon">sign<wbr>Arbitrary</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="user.html#signtransaction" class="tsd-kind-icon">sign<wbr>Transaction</a>
				</li>
				<li class=" tsd-kind-method tsd-parent-kind-class">
					<a href="user.html#verifykeyownership" class="tsd-kind-icon">verify<wbr>Key<wbr>Ownership</a>
				</li>
			</ul>
		</li>
	...
	<div class="content-wrap">
		<section class="tsd-panel tsd-comment">
			<div class="tsd-comment tsd-typography">
				<div class="lead">
					<p>Represents a logged in User and provides the ability to sign transactions as that user.</p>
				</div>
			</div>
		</section>
				...
				<div class="tsd-index-content">
					<section class="tsd-index-section ">
						...
						<ul class="tsd-index-list">
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-protected"><a href="user.html#buildrpcendpoint" class="tsd-kind-icon">build<wbr>Rpc<wbr>Endpoint</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="user.html#getaccountname" class="tsd-kind-icon">get<wbr>Account<wbr>Name</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="user.html#getchainid" class="tsd-kind-icon">get<wbr>Chain<wbr>Id</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="user.html#getkeys" class="tsd-kind-icon">get<wbr>Keys</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class tsd-is-protected"><a href="user.html#returneosjstransaction" class="tsd-kind-icon">return<wbr>Eosjs<wbr>Transaction</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="user.html#signarbitrary" class="tsd-kind-icon">sign<wbr>Arbitrary</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="user.html#signtransaction" class="tsd-kind-icon">sign<wbr>Transaction</a></li>
							<li class="tsd-kind-method tsd-parent-kind-class"><a href="user.html#verifykeyownership" class="tsd-kind-icon">verify<wbr>Key<wbr>Ownership</a></li>
						</ul>
					</section>
				</div>
			</section>
		...
		<section class="tsd-panel-group tsd-member-group ">
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-protected">
				<a name="buildrpcendpoint" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagProtected">Protected</span> build<wbr>Rpc<wbr>Endpoint</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-protected">
					<li class="tsd-signature tsd-kind-icon">build<wbr>Rpc<wbr>Endpoint<span class="tsd-signature-symbol">(</span>endPoint<span class="tsd-signature-symbol">: </span><a href="../interfaces/rpcendpoint.html" class="tsd-signature-type">RpcEndpoint</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/User.ts#L68">User.ts:68</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>endPoint: <a href="../interfaces/rpcendpoint.html" class="tsd-signature-type">RpcEndpoint</a></h5>
							</li>
						</ul>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="getaccountname" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> get<wbr>Account<wbr>Name</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Account<wbr>Name<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/User.ts#L29">User.ts:29</a></li>
							</ul>
						</aside>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="getchainid" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> get<wbr>Chain<wbr>Id</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Chain<wbr>Id<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/User.ts#L31">User.ts:31</a></li>
							</ul>
						</aside>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> get<wbr>Keys</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">get<wbr>Keys<span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/User.ts#L33">User.ts:33</a></li>
							</ul>
						</aside>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class tsd-is-protected">
				<a name="returneosjstransaction" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagProtected">Protected</span> return<wbr>Eosjs<wbr>Transaction</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class tsd-is-protected">
					<li class="tsd-signature tsd-kind-icon">return<wbr>Eosjs<wbr>Transaction<span class="tsd-signature-symbol">(</span>wasBroadcast<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">boolean</span>, completedTransaction<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="../interfaces/signtransactionresponse.html" class="tsd-signature-type">SignTransactionResponse</a></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/User.ts#L35">User.ts:35</a></li>
							</ul>
						</aside>
						<h4 class="tsd-parameters-title">Parameters</h4>
						<ul class="tsd-parameters">
							<li>
								<h5>wasBroadcast: <span class="tsd-signature-type">boolean</span></h5>
							</li>
							<li>
								<h5>completedTransaction: <span class="tsd-signature-type">any</span></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <a href="../interfaces/signtransactionresponse.html" class="tsd-signature-type">SignTransactionResponse</a></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="signarbitrary" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> sign<wbr>Arbitrary</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">sign<wbr>Arbitrary<span class="tsd-signature-symbol">(</span>publicKey<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, data<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span>, helpText<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/User.ts#L20">User.ts:20</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>The public key to use for signing.</p>
								</div>
							</li>
							<li>
							...
							<li>
								<h5>helpText: <span class="tsd-signature-type">string</span></h5>
								<div class="tsd-comment tsd-typography">
									<p>Help text to explain the need for arbitrary data to be signed.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4>
			...
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				...
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> sign<wbr>Transaction</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">sign<wbr>Transaction<span class="tsd-signature-symbol">(</span>transaction<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">any</span>, config<span class="tsd-signature-symbol">?: </span><a href="../interfaces/signtransactionconfig.html" class="tsd-signature-type">SignTransactionConfig</a><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/signtransactionresponse.html" class="tsd-signature-type">SignTransactionResponse</a><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/User.ts#L11">User.ts:11</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>The transaction to be signed (a object that matches the RpcAPI structure).</p>
								</div>
							</li>
							<li>
								<h5><span class="tsd-flag ts-flagOptional">Optional</span> config: <a href="../interfaces/signtransactionconfig.html" class="tsd-signature-type">SignTransactionConfig</a></h5>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><a href="../interfaces/signtransactionresponse.html" class="tsd-signature-type">SignTransactionResponse</a><span class="tsd-signature-symbol">&gt;</span></h4>
					</li>
				</ul>
			</section>
			<section class="tsd-panel tsd-member tsd-kind-method tsd-parent-kind-class">
				<a name="verifykeyownership" class="tsd-anchor"></a>
				<h3><span class="tsd-flag ts-flagAbstract">Abstract</span> verify<wbr>Key<wbr>Ownership</h3>
				<ul class="tsd-signatures tsd-kind-method tsd-parent-kind-class">
					<li class="tsd-signature tsd-kind-icon">verify<wbr>Key<wbr>Ownership<span class="tsd-signature-symbol">(</span>challenge<span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></li>
				</ul>
				<ul class="tsd-descriptions">
					<li class="tsd-description">
						<aside class="tsd-sources">
							<ul>
								<li>Defined in <a href="https://github.com/EOSIO/universal-authenticator-library/blob/34550eb/packages/universal-authenticator-library/src/User.ts#L27">User.ts:27</a></li>
							</ul>
						</aside>
						<div class="tsd-comment tsd-typography">
						</div>
						...
						<ul class="tsd-parameters">
							<li>
								...
								<div class="tsd-comment tsd-typography">
									<p>Challenge text sent to the authenticator.</p>
								</div>
							</li>
						</ul>
						<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></h4>
						<p>Whether the user owns the private keys corresponding with provided public keys.</p>
					</li>
				</ul>
			</section>
		</section>

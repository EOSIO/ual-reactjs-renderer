...
function runTestInternal(_x, _x2, _x3, _x4) {
...
function _runTest() {
  _runTest = _asyncToGenerator(function*(path, globalConfig, config, resolver) {
    const _ref = yield runTestInternal(path, globalConfig, config, resolver),

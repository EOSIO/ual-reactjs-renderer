  ...
  (function() {
    var _ref = _asyncToGenerator(function*(
      ...
      if (!data.tests.length && globalConfig.onlyChanged && data.noSCM) {
        new (_jestUtil()).Console(outputStream, outputStream).log(
  ...
  (function() {
    var _runJest = _asyncToGenerator(function*({
      ...
      if (globalConfig.listTests) {
        ...
        onComplete &&
          onComplete((0, _testResultHelpers.makeEmptyAggregatedTestResult)());
        return null;
      }
      ...
      if (!allTests.length) {
        ...
        if (
          ...
          new (_jestUtil()).Console(outputStream, outputStream).error(
            noTestsFoundMessage
          );
          (0, _exit().default)(1);
        }

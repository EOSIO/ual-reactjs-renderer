...
function normalize(options, argv) {
  ...
  Object.keys(options).reduce((newOptions, key) => {
    ...
    switch (key) {
      ...
      case 'haste':
        value = _objectSpread({}, options[key]);

        if (value.hasteImplModulePath != null) {
          value.hasteImplModulePath = (0, _utils.resolve)(newOptions.resolver, {
      ...
      case 'moduleFileExtensions': {
        value = options[key]; // If it's the wrong type, it can throw at a later time
